...
public class ClientProxy extends CommonProxy {
    ...
    private KeyBinding keyRotate;
    private KeyBinding keyBalance;
    private KeyBinding keyClear;
    private KeyBinding keyToggleButtons;
    private KeyBinding keyCompress;
    private KeyBinding keyDecompress;
    ...
    public void init(FMLInitializationEvent event) {
        ...
        keyRotate = new KeyBinding("key.craftingtweaks.rotate", Keyboard.KEY_NONE, "key.categories.craftingtweaks");
        keyBalance = new KeyBinding("key.craftingtweaks.balance", Keyboard.KEY_NONE, "key.categories.craftingtweaks");
        keyClear = new KeyBinding("key.craftingtweaks.clear", Keyboard.KEY_NONE, "key.categories.craftingtweaks");
        keyToggleButtons = new KeyBinding(
            "key.craftingtweaks.toggleButtons",
            Keyboard.KEY_NONE,
            "key.categories.craftingtweaks");
        keyCompress = new KeyBinding("key.craftingtweaks.compress", Keyboard.KEY_NONE, "key.categories.craftingtweaks");
        keyDecompress = new KeyBinding(
    ...
    public void onGuiClick(GuiClickEvent event) {
        ...
        if (entityPlayer != null) {
            ...
            if (container != null) {
                ...
                if (provider != null) {
                    if (isPressed(Minecraft.getMinecraft().gameSettings.keyBindForward)) {
            ...
            if (container != null) {
                ...
                if (provider != null) {
                    ...
                    if (guiScreen instanceof GuiContainer) {
                        if (isPressed(keyToggleButtons)) {
                            if (!wasToggleButtons) {
                                CraftingTweaksConfig.hideButtons = !CraftingTweaksConfig.hideButtons;
                                if (CraftingTweaksConfig.hideButtons) {
    ...
    public void onDrawScreen(GuiScreenEvent.DrawScreenEvent.Post event) {
        ...
        if (!CraftingTweaksConfig.hideButtonTooltips) {
            tooltipList.clear();
    ...
    private static boolean isPressed(KeyBinding keybind) {
